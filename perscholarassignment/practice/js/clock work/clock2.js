...
var limite;
var temporizador;
var workwork = document.getElementById("minute")

    workwork.addEventListener("keyup",
        function (event) {
            event.preventDefault();
            if (event.keyCode === 13) {
                botaoClicked()
                document.getElementById("second").focus()    //highlight seconds input
            }
...
function updateTime() {
    ...
    if (minutos >= limite) {
        ...
        document.getElementById("dot").className = "blue";
    }
}